...
//Switching animation
function switchin(switch_in, switch_out, scroll_top = true, track_order = false, callback = null)
{
...
function create_switch_menu(div_selector, options, screens, firstscreen = null)
{	
	/*
