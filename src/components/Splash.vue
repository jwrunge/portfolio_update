<template>
    <div id='nav' class='page'>
      <svg id="signature_svg" ref='signature' viewBox="0 0 1900 1300" xmlns="http://www.w3.org/2000/svg">
        ...
        <!--c--> <path class='sigC' stroke-dasharray="247" stroke-dashoffset="0"
        ...
        <!--o--> <path class='sigO' stroke-dasharray="348" stroke-dashoffset="0"
        ...
        <!--b--> <path class='sigB' stroke-dasharray="638" stroke-dashoffset="0"
        ...
        <!--R1--> <path class='sigR1' stroke-dasharray="317" stroke-dashoffset="0"
        ...
        <!--R2--> <path class='sigR2' stroke-dasharray="1430" stroke-dashoffset="0"
        ...
        <!--unge--> <path class='sigUnge' stroke-dasharray="2118" stroke-dashoffset="0"
        ...
        <!--Underline--> <path class='sigLine' stroke-dasharray="1235" stroke-dashoffset="0"
            d="M 327.20575,616.08499 C 636.13965,529.12582 1409.6185,494.79982 1553.7877,501.66502"/>
      </svg>
      
      <div ref='top_links' id='top_links'>
        <div v-if='signatureFinished || $parent.splashShown'>
          <transition-group name='itemin' appear @before-enter='$parent.beforeEnter' @enter='$parent.enter'>
            <router-link to='/about' key='0' data-index='1'>About</router-link>
            <router-link to='/services' key='1' data-index='2'>Services</router-link>
            <router-link to='/portfolio' key='2' data-index='3'>Portfolio</router-link>
          </transition-group>
        </div>
      </div>
    </div>
